...
.archive-subsection p:last-child {
  margin-bottom: 0;
}
...
The [Internet Archive](https://archive.org/) is a nonprofit digital library founded in 1996. Its best known service is the [Wayback Machine](https://web.archive.org/), which stores captures of websites and allows us to revisit them as they appeared at different points in time.
...
The [Pew Research Center examined webpages that existed between 2013 and 2023](https://www.pewresearch.org/data-labs/2024/05/17/when-online-content-disappears/). By October 2023, roughly one quarter were no longer accessible. Among pages that existed in 2013, **38 percent had disappeared within a decade**.
...
A May 2026 investigation by the [Nieman Journalism Lab](https://www.niemanlab.org/2026/05/more-than-340-local-news-outlets-are-limiting-the-internet-archives-access-to-their-journalism/) examined 382 news websites that restricted at least one Internet Archive affiliated crawler. Of those, **342 were local news sites**.
...
<section class="archive-subsection" markdown="1">
...
The Wayback Machine’s [Save Page Now](https://web.archive.org/save/) tool lets anyone submit a public webpage for preservation.
...
- [Internet Archive: General Information](https://help.archive.org/help/internet-archive-general-information/)
- [Internet Archive: One Trillion Web Pages Archived](https://blog.archive.org/2025/10/31/one-trillion-web-pages-archived-internet-archive-celebrates-a-civilization-scale-milestone/)
- [Pew Research Center: When Online Content Disappears](https://www.pewresearch.org/data-labs/2024/05/17/when-online-content-disappears/)
- [Internet Archive: End of Hachette v. Internet Archive](https://blog.archive.org/2024/12/04/end-of-hachette-v-internet-archive/)
- [Internet Archive: Response to the Appellate Opinion](https://blog.archive.org/2024/09/04/internet-archive-responds-to-appellate-opinion/)
- [Internet Archive: An Update on the Great 78s Lawsuit](https://blog.archive.org/2025/09/15/an-update-on-the-great-78s-lawsuit/)
- [Ars Technica: The Internet Archive’s Legal Fights Are Over](https://arstechnica.com/tech-policy/2025/11/the-internet-archive-survived-major-copyright-losses-whats-next/)
- [Nieman Journalism Lab: More Than 340 Local News Outlets Are Limiting Internet Archive Access](https://www.niemanlab.org/2026/05/more-than-340-local-news-outlets-are-limiting-the-internet-archives-access-to-their-journalism/)
- [Electronic Frontier Foundation: Blocking the Internet Archive Will Not Stop AI](https://www.eff.org/deeplinks/2026/03/blocking-internet-archive-wont-stop-ai-it-will-erase-webs-historical-record)
- [Internet Archive: FAQ on Publishers Blocking the Wayback Machine](https://help.archive.org/help/faq-publishers-blocking-the-wayback-machine/)
- [Internet Archive: Services Update Following the 2024 Attack](https://blog.archive.org/2024/10/21/internet-archive-services-update-2024-10-21/)
- [Internet Archive: Save Pages in the Wayback Machine](https://help.archive.org/help/save-pages-in-the-wayback-machine/)
- [Internet Archive: Donations and Gifts FAQ](https://blog.archive.org/donation-faqs/)
- [Internet Archive: Donating to Internet Archive Canada](https://help.archive.org/help/how-do-i-donate-to-the-internet-archive-canada/)
